...
import { AlertCircle, CheckCircle, Loader2, ArrowLeft, Settings } from "lucide-react"
        ...
        <div className="grid gap-6">
          <Card>
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div>
                <CardTitle>Delivery Tracking Setup</CardTitle>
                <CardDescription>
                  Set up the delivery tracking system to enable real-time order tracking
                </CardDescription>
              </div>
            </CardHeader>
            <CardContent>
