...
import { Loader2, MessageSquare, Mic, TrendingUp, Package } from "lucide-react"
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="flex flex-col items-center gap-2">
          ...
          <p>Initializing Retailer Dashboard...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold">AI Bandhu - Retailer Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <Card className="p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Get AI-powered product recommendations based on your order history and preferences.
            </p>
          </Card>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold">Order Insights</h3>
            </div>
            <p className="text-sm text-muted-foreground">
              Analyze your order patterns and get insights to optimize your purchasing strategy.
            </p>
          </Card>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold">Voice Orders</h3>
            </div>
            <p className="text-sm text-muted-foreground">
              Place orders using voice commands in English or Hindi for faster ordering.
            </p>
          </Card>
        </div>
      </div>
