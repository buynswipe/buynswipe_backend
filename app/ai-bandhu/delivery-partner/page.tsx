...
import { Loader2, MessageSquare, Mic, MapPin, TrendingUp, Clock } from "lucide-react"
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="flex flex-col items-center gap-2">
          ...
          <p>Initializing Delivery Partner Dashboard...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold">AI Bandhu - Delivery Partner Dashboard</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <Card className="p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Get AI-powered route suggestions to optimize your delivery path and save time.
            </p>
          </Card>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="font-semibold">Earnings Tracking</h3>
            </div>
            <p className="text-sm text-muted-foreground">
              Monitor your earnings, performance metrics, and get insights to increase income.
            </p>
          </Card>
          ...
          <Card className="p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Voice-enabled delivery tracking and real-time updates for your assigned orders.
            </p>
          </Card>
        </div>
      </div>
