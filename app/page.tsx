...
export const metadata: Metadata = {
  title: "Retail Bandhu - Connecting Retailers and Wholesalers in India",
  description:
    "Retail Bandhu is a comprehensive platform that connects retailers with wholesalers, streamlining inventory management, order processing, and delivery tracking for FMCG businesses across India.",
  keywords:
    "FMCG supply chain, retail management, wholesale platform, inventory management, order tracking, retail business, supply chain, Indian retailers, B2B marketplace",
}
